...
You already have an interactive environment where you can run commands from the script in the console below and see the results. To see this, type this in the script file

...{r}
1+1
...
Then, leaving the cursor on that line, click the Run button at the right top of the script file. Below, in the console, you'll see the answer
